...
class Zombie(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.rect = pygame.Rect(750, random.randint(100, 400), 100, 100)
...
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            pygame.time.set_timer(ADDZOMBIE, random.randint(5000, 8000))
    ...
    if not game_over:
        ...
        for zombie in zombies:
            if not zombie.passed and zombie.rect.right < player.rect.left:
                zombie.passed = True
                score += 1
        ...
        screen.blit(game_over_text, (270, 180))
        screen.blit(score_text, (250, 240))
